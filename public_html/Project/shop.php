...
$results = [];
$db = getDB();
$stmt = $db->prepare("SELECT id, name, description, category, cost, stock FROM Products WHERE stock > 0 AND visibility = 1 LIMIT 50");
try {
    $stmt->execute();
            ...
            <div class="col">
                <div class="card bg-light">
                    ...
                    <div class="card-body">
                        ...
                        <a href="product_details.php?id=<?php se($item, "id"); ?>">Details</a>
                    </div>
